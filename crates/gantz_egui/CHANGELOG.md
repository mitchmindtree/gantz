...
## [0.5.0](https://github.com/mitchmindtree/gantz/compare/gantz_egui-v0.4.0...gantz_egui-v0.5.0) - 2026-07-11
...
- *(gantz_egui)* node views for number/expr/branch; rename + revert ([#271](https://github.com/mitchmindtree/gantz/pull/271))
- *(gantz_egui)* full-bleed node views; plot fills its pane ([#271](https://github.com/mitchmindtree/gantz/pull/271))
...
- *(bevy_gantz)* drive recompiles from committed CA; commit at edit sites ([#159](https://github.com/mitchmindtree/gantz/pull/159))
...
- *(gantz_egui)* polish node-view panes per review ([#271](https://github.com/mitchmindtree/gantz/pull/271))
...
- *(gantz_egui)* make node views first-class top-level tiles ([#271](https://github.com/mitchmindtree/gantz/pull/271))
